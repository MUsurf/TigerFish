...
class ServoController(Node):
    def __init__(self, servo_index):
        ...
        self.channel = self.pca.channels[
            servo_index
        ]  # PCA has 16 channels (0-15), each servo will use different
        ...
        self.subscription = self.create_subscription(
            Float32, self.subscribedTopic, self.set_servo_angle, self.queue_size
        )
    ...
    def set_servo_angle(self, msg):
        ...
        self.channel.dity_cycle = self.angle_to_duty(
            angle
        )  # Convert angle to PWM and sent to I/O
