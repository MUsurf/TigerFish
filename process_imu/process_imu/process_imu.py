...
class ProcessImuNode(Node):
    ...
    def _imu_cb(self, msg: Imu):
        ...
        filt_orientation = self._low_pass(
            self.prev_orientation, current_orientation, self.alpha
        )
        filt_ang_vel = self._low_pass(self.prev_ang_vel, current_ang_vel, self.alpha)
        filt_linear_accel = self._low_pass(
            self.prev_lin_accel, current_linear_accel, self.alpha
        )
        ...
        (
            filtered_msg.orientation.x,
            filtered_msg.orientation.y,
            filtered_msg.orientation.z,
            filtered_msg.orientation.w,
        ) = filt_orientation
        (
        ...
        filtered_msg.linear_acceleration_covariance = list(
