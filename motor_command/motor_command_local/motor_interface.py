...
# Begin imports
from motor_command_local.motor_commander import MotorCommand
import time
# End imports
...
class MotorInterface():
    ...
    def clo_seq(self) -> None:
        ...
        self.last_directions = [0 for _ in range(self.numMotors)]
    ...
    def callback(self, message_rec):
        ...
        print("Data received is: " + str(message_rec))
        self.last_directions = message_rec
        self.new_directions = True
